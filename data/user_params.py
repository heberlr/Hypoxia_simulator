...
class UserTab(object):
    ...
    def __init__(self):
        ...
        param_name6 = Button(description='perst_time_red', disabled=True, layout=name_button_layout)
        ...
        param_name9 = Button(description='perst_time_green', disabled=True, layout=name_button_layout)
        ...
        param_name12 = Button(description='uptake_rate', disabled=True, layout=name_button_layout)
        ...
        param_name18 = Button(description='production_rate', disabled=True, layout=name_button_layout)
        ...
        param_name19 = Button(description='degradation_rate', disabled=True, layout=name_button_layout)
        ...
        desc_button5 = Button(description='motility speed for DsRed+ cells' , tooltip='motility speed for DsRed+ cells', disabled=True, layout=desc_button_layout) 
        desc_button5.style.button_color = 'lightgreen'
        desc_button6 = Button(description='motility persistence time for DsRed+ cells' , tooltip='motility persistence time for DsRed+ cells', disabled=True, layout=desc_button_layout) 
        desc_button6.style.button_color = 'tan'
        desc_button7 = Button(description='motility bias for DsRed+ cells' , tooltip='motility bias for DsRed+ cells', disabled=True, layout=desc_button_layout) 
        desc_button7.style.button_color = 'lightgreen'
        desc_button8 = Button(description='motility speed for GFP+ cells' , tooltip='motility speed for GFP+ cells', disabled=True, layout=desc_button_layout) 
        desc_button8.style.button_color = 'tan'
        desc_button9 = Button(description='motility persistence time for GFP+ cells' , tooltip='motility persistence time for GFP+ cells', disabled=True, layout=desc_button_layout) 
        desc_button9.style.button_color = 'lightgreen'
        desc_button10 = Button(description='motility bias for GFP+ cells' , tooltip='motility bias for GFP+ cells', disabled=True, layout=desc_button_layout) 
        ...
        desc_button12 = Button(description='uptake rates for the oxygen' , tooltip='uptake rates for the oxygen', disabled=True, layout=desc_button_layout) 
        ...
        row6 = [param_name6, self.perst_time_red, units_button6, desc_button6] 
        row7 = [param_name7, self.bias_red, units_button7, desc_button7] 
        row8 = [param_name8, self.speed_green, units_button8, desc_button8] 
        row9 = [param_name9, self.perst_time_green, units_button9, desc_button9] 
        ...
        row12 = [param_name12, self.uptake_rate, units_button12, desc_button12] 
        ...
        row18 = [param_name18, self.production_rate, units_button18, desc_button18] 
        row19 = [param_name19, self.degradation_rate, units_button19, desc_button19] 
